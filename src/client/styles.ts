...
/**
 * Error summary bar shown below a failed render: red-tinted strip with the
 * truncated error message and ghost copy / send-to-AI actions, matching the
 * banner's action-button language.
 */
const ERROR_CSS = `
.dsh-mermaid-error {
  display: flex;
