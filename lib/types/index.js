...
import { CONFIG_ROUTE, DIST_PREFIX, MERMAID_DIST_FILE, MERMAID_BUNDLE, validateConfig } from "./protocol.js";
 ...
 */
export async function serveDistFile(distRoot, pathname, res) {
